    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200"> */}
          ...
          <div className="mx-auto sm:col-span-6 md:col-span-3 lg:col-span-2 flex items-center">
            <h6 className="text-gray-800 font-medium mr-2">System Requirements:</h6>
            {/* <div className="text-sm text-gray-600 mx-auto">&copy; KLOYTools.com. All rights reserved.</div> */}
            <div className="text-sm text-gray-600 mx-auto">macOS 14.0 or later.</div>
          </div>
          </div>


          {/* <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2">System Requirements</h6>
